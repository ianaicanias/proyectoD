...
/**
 * Interfaz que define el comportamiento de un lector de archivos, @see LectorDeArchivosCSV.
...
public interface LectorDeArchivos {
    ...
    /**
     * Carga receptores desde un archivo e intenta registrar cada uno en el sistema.
     ...
     *
     * @param rutaDelArchivoDeReceptores Ruta del archivo con los datos de los receptores.
     */
    void cargarReceptores(String rutaDelArchivoDeReceptores);
    
    /**
     * Carga donantes desde un archivo e intenta registrar cada uno en el sistema.
     * Si un donante ya existe (cédula duplicada), se informa por consola y se omite.
     * Si el archivo no se encuentra, se informa por consola y no se realiza ninguna acción.
     * El scanner se cierra siempre en el bloque finally.
     *
     * @param rutaDelArchivoDeDonantes Ruta del archivo con los datos de los donantes.
     */
